...
# Install luarocks and to resolve lazyvim :checkhealth warnings
sudo apt install -y luarocks

# Install tree-sitter-cli to resolve lazyvim :checkhealth warnings
source ~/.local/share/omakub/install/terminal/tool-tree-sitter-cli.sh
